...
<aside class="sidebar">
    ...
    <nav class="menu">
        ...
        <a href="{{ route('siswa.perizinan.sakit') }}"><i class="bi bi-file-earmark-medical"
                aria-hidden="true"></i>Izin</a>
        <a href="{{ route('siswa.dispen.index') }}"><i class="bi bi-file-earmark-text"
                aria-hidden="true"></i>Dispensasi</a>
