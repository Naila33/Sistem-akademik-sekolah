...
@section('content')
    <div class="academic-form">
        <div class="academic-panel">
            <h1>Edit Kelas</h1>
            <p class="academic-subtitle">Form untuk mengubah data kelas.</p>
            ...
            <form action="{{ route('kelas.update', $kelas->id) }}" method="POST">
                ...
                <div class="academic-field">
                    ...
                    <select id="tingkat" name="tingkat" required>
                        @foreach(['X','XI','XII'] as $tingkat)
                            <option value="{{ $tingkat }}" @selected(old('tingkat', $kelas->tingkat) === $tingkat)>
                                {{ $tingkat }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="academic-actions">
                    ...
                    <a class="academic-back" href="{{ route('kelas.index') }}">
                        Kembali
                    </a>
                </div>
            </form>
