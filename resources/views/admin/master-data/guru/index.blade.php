...
<div class="card">
    ...
    <div style="margin: 12px 0; padding: 12px; border: 1px solid #d0d7de; border-radius: 8px; background: #f6f8fa;">
        ...
        <table>
            ...
            <tbody>
                @forelse($gurus as $guru)<tr>
                    ...
                    <td>{{ $guru->nama }}</td>
                    <td>{{ $guru->jk }}</td>
                    <td>{{ optional($guru->tgl_lahir)->format('d-m-Y') }}</td>
                    <td>{{ $guru->agama }}</td>
                    <td>{{ $guru->alamat }}</td>
                    <td>{{ $guru->no_hp }}</td>
                    <td>{{ $guru->email }}</td>
                    <td>{{ str_replace('_',' ',$guru->status_kepegawaian) }}</td>
                    <td>{{ str_replace('_',' ',$guru->jabatan) }}</td>
                    <td>{{ optional($guru->tmt)->format('d-m-Y') }}</td>
                    ...
                    <td colspan="14">Belum ada data guru.</td>
                </tr>@endforelse
            </tbody>
        </table>
    </div>
