...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="mb-4">
            ...
            <a href="{{ route('admin.penilaian.pjbl.index') }}" class="text-decoration-none text-muted">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        ...
                        <label for="searchPjbl" class="form-label fw-semibold">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="searchPjbl" class="form-control"
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="filterTanggal" class="form-label fw-semibold">
        ...
        <div class="mb-3">
            ...
            <small class="text-muted">
                ...
                <span id="jumlahPjbl" class="fw-semibold text-dark">
