...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">{{ $calonSiswa->no_pendaftaran }}</p>
<<<<<<< Updated upstream
<<<<<<< Updated upstream
>>>>>>> Stashed changes
=======
...
>>>>>>> Stashed changes
    ...
    <div class="header-actions">
        <a href="{{ route('admin.spmb.show', $calonSiswa->id) }}" class="btn-back">
            Kembali
        </a>
    </div>
</div>
            ...
            <div class="info-box">
                <div>
                    ...
                    <div class="info-box-text">
                        ...
                        Proses upload dan verifikasi dokumen dilakukan melalui halaman detail calon siswa.
                    </div>
                </div>
            </div>
        </div>
